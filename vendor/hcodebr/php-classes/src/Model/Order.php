...
class Order extends Model {
	...
	public function setPagSeguroTransactionResponse(string $descode,float $vlgrossamount,float $vldisccountamount, float $vlfeeamont, float $vlnetamount,float $extraamount, string $despaymentlink = ""){
		$sql = new Sql();
