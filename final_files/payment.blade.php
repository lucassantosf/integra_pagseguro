                                        ...
                                        <div id="payment-methods" class="hide">
                                            ...
                                            <div class="tab-content">
                                                <div class="tab-pane" id="tab-boleto" role="tabpanel">
                                                    ...
                                                    <form action="{{route('pagamento.boleto')}}" class="checkout" method="post" name="checkout" style="padding:10px;" id="form-boleto">
                                                        @csrf
                                                        <div class="row">
                                                            <div class="col-sm-4">
                                                ...
                                                <div class="tab-pane" id="tab-debito" role="tabpanel">
                                                    ...
                                                    <form action="{{route('pagamento.debito')}}" class="checkout" method="post" name="checkout" style="padding:10px;" id="form-debit">
                                                        @csrf
                                                        <div class="row">
                                                            <div class="col-sm-4">
                                                                <div class="form-row form-row-wide address-field validate-required">
                                                ...
                                                <div class="tab-pane" id="tab-credito" role="tabpanel">
                                                    ...
                                                    <form action="{{route('pagamento.credito')}}" class="checkout" method="post" name="checkout" style="padding:10px;" id="form-credit">
                                                        @csrf
...
<script src="{{$pagsegurourlJS}}"></script>
<script type="text/javascript">
    //1º Abrir sessão
    PagSeguroDirectPayment.setSessionId('{{$pagseguroid}}');
</script> 
<script type="text/javascript">
    ...
    scripts.push(function(){ 
        //2º Meios de Pagamento
        //Recuperar todos meios de pagamento
        PagSeguroDirectPayment.getPaymentMethods({ 
            amount: parseFloat("500"), /* Valor total do pedido*/
        ...
        //3º Quantidade de parcelas permitidas 
            ...
            if(value.length >= 6 ){
                PagSeguroDirectPayment.getBrand({
                    ...
                    success: function(response) {
                        ...
                        //4º Quantidade de parcelas permitidas 
                        //Recuperar opções de parcelamentos de acordo á como cada bandeira aceita
                        PagSeguroDirectPayment.getInstallments({
                                amount: parseFloat("500"),
                                maxInstallmentNoInterest: parseInt("{{$pagseguromaxInstallmentNoInterest}}"),
                                ...
                                success: function(response){   
                                    ...
                                    $.each(response.installments[$("#brand_field").val()], function(index, installment){
                                        ...
                                        if(parseInt("{{$pagseguromaxInstallment}}") > index){ 
                                            //Sem juros
        ...
        //5º Crir token e hash do cartão de crédito 
        //Recuperar Token do Cartão de Crédito - Método de Pagamento
        $("#form-credit").on("submit",function(e){
            ...
            //Método que efetivamente cria o token
            PagSeguroDirectPayment.createCardToken({
                ...
                success: function(response) {
                    ...
                    $.post(APP_URL+"payment/credit", 
                        $.param(params),
                        function(r){
                            var response = JSON.parse(r); 

                            if(response.success){
                                window.location.href = APP_URL+"minhaconta/meuspedidos"; 
                            }else{
        ...
        $("#form-boleto").on("submit",function(e){
            ...
            $("#form-boleto [type=submit]").attr("disabled","disabled");
        ...
        $("#form-debit").on("submit",function(e){
            ...
            $("#form-debit [type=submit]").attr("disabled","disabled");
